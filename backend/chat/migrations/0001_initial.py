# Generated by Django 4.2.28 on 2026-02-05 18:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participants', models.ManyToManyField(blank=True, related_name='active_calls', to=settings.AUTH_USER_MODEL)),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='call_sessions', to='chat.room')),
            ],
            options={
